...
- **v1.9.2 수정(2026-07-08, 뷰어 측)**: ① fan 다음 "I'm sitting down at my desk." 추가(102→103문장) ② IQOS 스틱 넣기를 흡연→사무실 도착(charging 뒤)으로 이동 ③ second lane → **middle lane** 교정(미국식 위치 호칭) — **문구가 바뀌어 ST_REFS의 해당 참조도 함께 교체**(13개 유지 확인).
- **v1.9.3 추가(2026-07-08, 뷰어 측)**: 사무실 주차의 차에서 내리기 뒤에 "I'm locking the car." 추가. 103→104문장.
